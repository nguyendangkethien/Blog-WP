...
<style type="text/css">
    /*
     * Blog Designer lightbreeze template
     */
    ...
    .blog_template.bdp_blog_template.box-template .social-component {
    ...
    /*
     * Blog Designer classical template
     */
    ...
    .blog_template.bdp_blog_template.classical .social-component {
        display: inline-block;
    }
    .wl_pagination_box .wl_pagination span, .wl_pagination_box .wl_pagination a{
        background: <?php echo $readmorebackcolor; ?>;
    ...
    /*
     * Blog Designer spektrum template
     */
    .spektrum .date {
        color: <?php echo $background; ?>;
    }
    ...
    /*
     * Blog Designer evolution template
     */
    .marketer .post-title{
        background: <?php echo $titlebackcolor; ?>;
    }
    ...
    .bdp_blog_template.marketer .social-component {
        display: inline-block;
    }
    ...
    /*
     * Blog Designer timeline template
     */
    ...
    .blog_template.bdp_blog_template.timeline .social-component {
        box-sizing: border-box;
        float: left;
        margin-bottom: 0;
        width: 100%;
    ...
    .entry-content .wl_pagination_box a {
        box-shadow: none;
    }
    /*
     * Social icon style
