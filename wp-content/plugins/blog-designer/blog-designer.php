            ...
            if (!function_exists('bd_remove_footer_admin')) {
                ...
                function bd_remove_footer_admin() {
                    ...
                    <p id="footer-left" class="alignleft">
                        ...
                        <a class="bdp-rating-link" data-rated="Thanks :)" target="_blank" href="https://wordpress.org/support/view/plugin-reviews/blog-designer?filter=5#postform">&#x2605;&#x2605;&#x2605;&#x2605;&#x2605;</a>
                        <?php _e('rating. A hearty thank you from Solwin Infotech in advance!', 'wp_blog_designer'); ?>
                    </p><?php
                    return ob_get_clean();
                }
    ...
    function wp_evolution_template($alterclass) {
        ...
        <div class="blog_template bdp_blog_template marketer <?php echo $alterclass; ?>">
            ...
            <div class="post-entry-meta"><?php if (get_option('display_date') == 0) { ?>
                ...
                if (get_option('display_comment_count') == 0) {
                    if (!post_password_required() && ( comments_open() || get_comments_number() )) :
                        ?>
                        <span class="comment">
                            <span class="icon_cnt"><i class="fa fa-comment"></i><?php comments_popup_link('0', '1', '%'); ?></span>
                        </span><?php
                    endif;
                }
                if (get_option('display_tag') == 0) {
            ...
            <div class="post-content-body">
                ...
                ?>
            </div><?php if (get_option('rss_use_excerpt') == 1): ?>
                <div class="post-bottom">
                    <?php
                    global $post;
                    if (get_option('read_more_text') != '') {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="bdp-setting-description">
                                                                ...
                                                                <?php
                                                                _e('You are about to select the page for your blog layout, you will lost your page content. There is no undo. Think about it!', 'wp_blog_designer');
                                                                ?>
                                                            </div>
                                                        </td>
                                                    </tr>
                ...
                <div class="bd-help">
                    ...
                    <div class="help-wrapper">
                        ...
                        <span><?php _e(' You can help by', 'wp_blog_designer'); ?>
                            <a href="https://wordpress.org/support/view/plugin-reviews/blog-designer?filter=5#postform" target="_blank">
                    ...
                    <div class="help-wrapper">
                        <div class="pro-content">
                            <ul class="advertisementContent">
                                <li><?php _e("17 Beautiful Blog Templates", 'wp_blog_designer') ?></li>
                                <li><?php _e("50+ Blog Layout Variations", 'wp_blog_designer') ?></li>
                            ...
                            <p class="pricing_change">Now only at <del>$29</del> <ins>$19</ins></p>
                        </div>
